  ...
  try {
    ...
    return res.json({
      health: {
        ...
        uptime_hours: parseFloat((uptimeSeconds / 3600).toFixed(1)),
        ...
        system_memory_used_pct: Math.round(((totalMem - freeMem) / totalMem) * 100),
        cpu_count: cpus.length,
        cpu_load_1m: cpuLoad[0]?.toFixed(2),
        cpu_load_5m: cpuLoad[1]?.toFixed(2),
        cpu_load_15m: cpuLoad[2]?.toFixed(2),
